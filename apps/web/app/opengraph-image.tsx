    ...
    >
      <div
        style={{
          ...
          borderRadius: 999,
          background:
            "radial-gradient(circle, rgba(29,185,84,0.18) 0%, rgba(29,185,84,0.04) 42%, transparent 72%)",
          filter: "blur(8px)",
        }}
      />
      <div
      ...
      <div
        style={{
          ...
          maskImage:
            "linear-gradient(to bottom, rgba(0,0,0,0.48), transparent 72%)",
          opacity: 0.25,
        }}
      />
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div
              style={{
                ...
                background:
                  "linear-gradient(145deg, rgba(255,255,255,0.08), rgba(29,185,84,0.08))",
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ fontSize: 18, color: "rgba(255,255,255,0.56)" }}>
          ...
          >
            ...
            >
              Diary entries, ratings, episode progress, and shared watchlists
              stay organized across web and mobile.
            </div>
          </div>
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", minWidth: 0 }}>
          <div style={{ fontSize: 22, fontWeight: 700, color: "#f5f5f3" }}>
            {title}
          </div>
          <div
            style={{
