...
import { type DiaryFilterState, DiaryFilters } from '@/components/diary/diary-filters'
  ...
  return (
    <Card className="grid grid-cols-[40px_44px_minmax(0,1fr)_auto] items-center gap-3 p-3 lg:grid-cols-[48px_56px_minmax(0,1fr)_160px_auto] lg:gap-4 lg:p-4">
      ...
      <div className="min-w-0">
        <Link className="block min-w-0" href={titlePath(entry.tmdbId, entry.titleName, entry.type)}>
      ...
      <button
        ...
        className="grid h-9 w-9 place-items-center rounded-md text-kino-muted hover:bg-white/6 lg:hidden"
