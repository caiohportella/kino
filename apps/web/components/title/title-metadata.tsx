...
import type { MediaType, TitleDetails, TitleRatingStats } from "@kino/core";
...
import type { KinoReviewAuthor } from "@kino/core";
  ...
  return (
    <Card className="grid gap-3 p-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Stat
          icon={
            <Star aria-hidden="true" className="text-kino-accent" size={14} />
          }
          label={
            type === "movie"
              ? t("title.avgMovieRating")
              : t("title.avgSeriesRating")
          }
...
export function TitleDiscoverySection({
  ...
  return (
    <>
      ...
      <MoreLikeThis
        error={
          contextQuery.data?.errors.recommendations || contextQuery.isError
        }
